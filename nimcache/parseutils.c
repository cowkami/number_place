...
/* Command for C compiler:
   gcc -c  -w  -I/usr/lib/nim -o /home/lee/nim_projects/number_place/nimcache/parseutils.o /home/lee/nim_projects/number_place/nimcache/parseutils.c */
...
STRING_LITERAL(TMP279, "overflow", 8);
	...
	nimln(200, "parseutils.nim");
	{
		...
		(*b) = IL64(0);
		{
			...
			while (1) {
				...
				TMP272 = mulInt64((*b), IL64(10));
				if ((NU)(i) > (NU)(s->Sup.len)) raiseIndexError();
				TMP273 = subInt(((NI) (((NU8)(s->data[i])))), ((NI) 48));
				TMP274 = subInt64((NI64)(TMP272), ((NI64) ((NI)(TMP273))));
				(*b) = (NI64)(TMP274);
		...
		TMP277 = mulInt64((*b), sign);
		(*b) = (NI64)(TMP277);
		nimln(207, "parseutils.nim");
		TMP278 = subInt(i, start);
		result = (NI)(TMP278);
	}
	LA10: ;
	popFrame();
...
N_NIMCALL(NI, npuParseInt)(NimStringDesc* s, NI* number, NI start) {
	...
	nimln(228, "parseutils.nim");
	{
		...
		e_98255 = (Overflowerror4043*) newObj((&NTI25717), sizeof(Overflowerror4043));
		(*e_98255).Sup.Sup.Sup.m_type = (&NTI4043);
		nimln(2508, "system.nim");
		LOC9 = 0;
		LOC9 = (*e_98255).Sup.Sup.message; (*e_98255).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP279));
